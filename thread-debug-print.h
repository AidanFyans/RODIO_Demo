...
// Generated functions for use within plugin Radio Coexistence
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_COEXISTENCE)
#define emberAfPluginCoexistencePrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_COEXISTENCE, __VA_ARGS__)
#define emberAfPluginCoexistencePrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_COEXISTENCE,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginCoexistenceFlush()
#define emberAfPluginCoexistenceDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_COEXISTENCE) ) { x; }
#define emberAfPluginCoexistencePrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_COEXISTENCE, (buffer), (len), (withSpace))
#define emberAfPluginCoexistencePrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_COEXISTENCE, (buffer))
#else
#define emberAfPluginCoexistencePrint(...)
#define emberAfPluginCoexistencePrintln(...)
#define emberAfPluginCoexistenceFlush()
#define emberAfPluginCoexistenceDebugExec(x)
#define emberAfPluginCoexistencePrintBuffer(buffer, len, withSpace)
#define emberAfPluginCoexistencePrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_COEXISTENCE)
...
// Generated functions for use within plugin I2C Driver Stub
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB)
#define emberAfPluginI2cDriverStubPrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB, __VA_ARGS__)
#define emberAfPluginI2cDriverStubPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginI2cDriverStubFlush()
#define emberAfPluginI2cDriverStubDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB) ) { x; }
#define emberAfPluginI2cDriverStubPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB, (buffer), (len), (withSpace))
#define emberAfPluginI2cDriverStubPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB, (buffer))
#else
#define emberAfPluginI2cDriverStubPrint(...)
#define emberAfPluginI2cDriverStubPrintln(...)
#define emberAfPluginI2cDriverStubFlush()
#define emberAfPluginI2cDriverStubDebugExec(x)
#define emberAfPluginI2cDriverStubPrintBuffer(buffer, len, withSpace)
#define emberAfPluginI2cDriverStubPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_I2C_DRIVER_STUB)
